...
public class GameControl {
	...
	// used to control the length of game and when to naturally quit the timer
	// thread
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Press any key and enter to start .. then estimate when " + gameLength + " secs have elasped");
		sc.nextLine();
