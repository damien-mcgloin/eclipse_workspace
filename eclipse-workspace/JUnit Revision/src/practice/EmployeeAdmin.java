...
public class EmployeeAdmin {
	...
	/**
	 * Searches a list of employees by age and returns all found below the specified
	 * age
	 * 
	 * @param employees
	 * @param age
	...
	// create a method that will search a list of employees by name and returns all
	// found that match the name - then test it
