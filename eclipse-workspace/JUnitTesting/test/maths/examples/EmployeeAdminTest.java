...
class EmployeeAdminTest {
	...
	void testGetAllEmployeesByName() {
		...
		ArrayList<Employee> returnedSearchByName = EmployeeAdmin.getAllEmployeesByName(employees, "employeeName1");
		
		System.out.println(returnedSearchByName.size());
		
		assertTrue(returnedSearchByName.size() == 1 && returnedSearchByName.contains(employee1));
