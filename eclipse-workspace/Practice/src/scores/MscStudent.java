...
public class MscStudent extends Student {
	...
	/**
	 * Private method that calculates the average score for the student Note : The
	 * programming result is double weighted
	 * 
	...
	/**
	 * Calculates and sets the classification for this student error < 0 or > 100
	 * distinction 70 - 100 commendation 60 - 69 pass 50 -59 fail 0 - 49
	 */
